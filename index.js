...
app.get('/register', (req, res) => {  //get : create a new ressource, req : request, res : response, font partie de la norme http
...
app.get('/login', (req, res) => {
  logUser(req.query).then(doc => {   //On essaie de se loguer en fct d'un log et d'un mdp. On cherche si ya un user qui a des log qui sont ont été inscrits
    if (doc) {
