...
const createRestaurant = async obj => {  //On définit une fonction pour créer nos restaurants, les acces à la bdd mongo sont asynchrons (définit comme ça)
  ...
  if (doc) {  //Evitons les doublons, et
